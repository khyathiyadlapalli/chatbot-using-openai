...
Note: ONLY used the packages provided in the requirements.txt file.
...
Note:while using this code make sure to create a .env file and store you openai_api key
